...
describe('currentPageSpeciesSlice tests', () => {
  it('init state', () => {
    const result = currentPageSpeciesSlice(undefined, { type: '' });
    expect(result).toEqual(initialState);
  });

  it('should add new items on current page', () => {
    const action = { type: addCurrentPageSpecies.type, payload: payloadSlice };

    const result = currentPageSpeciesSlice(initialState, action);
